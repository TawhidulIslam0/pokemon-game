...
* **Become a Pokémon Master**: Correctly identify every single Pokémon to unlock the elite "Pokémon Master" victory screen.
* **Persistent Progress**: Your successful guesses are automatically saved to your browser, tracking your collection journey.
...
* **Clean, Focused UI**: A minimalist, high-intensity interface designed to keep your eyes on the game.

## Technologies Used
* **React**: Built with functional components and hooks for a responsive experience.
